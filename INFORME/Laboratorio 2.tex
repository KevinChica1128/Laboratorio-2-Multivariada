...
~\\En esta tabla podemos ver las estadísticas descriptivas de los presupuestos para las variables medidas a las familias muestreadas de cada provincia española. Se puede observar que en cuanto a los promedios, como es de esperarse, las familias en general, destinan o gastan mas dinero de su presupuesto en la alimentación, con un promedio de 600781 por familia, seguido de los gastos en vivienda, que son en promedio de 499956 por familia. En cambio, en lo que menos gastan las familias es en gastos sanitarios, con un promedio de 55104. El gasto máximo que tuvo una familia fue en vivienda, con un gasto familiar de 864553 y el gasto mínimo, fue precisamente en gastos sanitarios, con un gasto familiar de solo 24476. En cuanto a la variación de los gastos familiares. Las familias tienen gastos menos variables en los gastos sanitarios, con una desviación estándar de solo 16702.17, lo contrario sucede con los gastos familiares en vivienda, donde cada familia tiene gastos muy variables en este aspecto, presenta una desviación estándar de 107438.
\begin{figure}[h!]
  \centering
